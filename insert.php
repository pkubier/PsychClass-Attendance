...
if(!empty($best_known_ip))
	...
	$statement = $mysqli->prepare("INSERT INTO CRN10688 (timestamp,ip,id,name) VALUES(?,?,?,?)"); //prepare sql insert query
	//bind parameters for markers, where (s = string, i = integer, d = double,  b = blob)
	$statement->bind_param('ssss', $timestamp, $ip, $id, $name); //bind values and execute insert query
