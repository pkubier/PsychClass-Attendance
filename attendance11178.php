...
<head>
    <meta charset="UTF-8">
    <title>Psychology Attendance CRN 11178</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Psychology Attendance<br/> CRN 11178</h2>
                    </div>
                    ...
                    <form action="insert11178.php" method="post">
                        <div class="form-group">
                            <label>First and Last Name</label>
                            <input type="text" name="name" class="form-control">
                            <label>Student ID</label>
                            <input type="text" name="id" class="form-control">
                            <label>Are you sitting in the same spot as shown <a href="11178.png" data-lightbox="11178" data-title="Class Seating Chart">here?</a><br>
